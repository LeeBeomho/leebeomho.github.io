...
public class DescendingInsertionSort {
	public static void main(String[] args) {
		...
		//int[] array= {1, 2, 3, 4, 5, 6}; //최악의 경우
		//int[] array= {6, 5, 4, 3, 2, 1}; //최선의 경우
		
		System.out.println(Arrays.toString(array));
		
		descendingInsertionSortArrayInt(array);
		
		System.out.println(Arrays.toString(array)+" 최종");
	}
	public static void descendingInsertionSortArrayInt(int[] array) {
